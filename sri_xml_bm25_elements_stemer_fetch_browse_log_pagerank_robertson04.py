...
for query_id in querys.keys():
    ...
    with open('run_xml/FaresIbrahimaSolofo_{}_{}_bm25_elements_stemer_k{}b{}_fetch_browse_log_pagerank_robertson04.txt'.format(NUM_RUN, NUM_FILE, k1, b), 'a') as run_file:
        run_file.write(run)
